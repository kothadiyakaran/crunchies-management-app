...
Sprint 10 (Internal QA + buffer — 8-flow `verify-launch-readiness.py` against synthetic + backfilled data; `--browser chromium|firefox|webkit` cross-browser smoke; buffer absorbs any debt from Sprints 1-9 including the `billPdf.ts` static-import carry and the contrast-token retune if Karan approves) is the active sprint. Then the in-person launch session. **Open Sprint 0 carry**: install + launch verified on mom's actual Android (§14 line 1538) — still pending; Karan can do this asynchronously by opening `crunchies.app` on her phone and installing to home screen. Architectural decisions for Sprint 9 captured in `docs/decisions/2026-05-22-sprint-9-architecture-decisions.md`; Sprint 8 in `docs/decisions/2026-05-22-sprint-8-architecture-decisions.md`; Sprint 7 in `docs/decisions/2026-05-22-sprint-7-architecture-decisions.md`; Sprint 6 in `docs/decisions/2026-05-22-sprint-6-architecture-decisions.md`; Sprint 5 in `docs/decisions/2026-05-22-sprint-5-architecture-decisions.md`; Sprint 3-4 in `docs/decisions/2026-05-21-sprint-3-4-architecture-decisions.md`; Sprint 2 in `docs/decisions/2026-05-21-sprint-2-architecture-decisions.md`.
